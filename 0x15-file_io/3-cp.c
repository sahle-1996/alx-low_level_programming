...
/**
 * check97 - looks for the right number of arguments.
...
/**
 * check98 - looks if  file_from present and if it is readable.
...
/**
 * check99 - looks for file_to is made and/or is written to.
 * @check: checks if true of false.
 * @file: file_to name.
 * @fd_from: file descriptor of file_from, or -1.
 * @fd_to: file descriptor of file_to, or -1.
...
/**
 * check100 - checking if file descriptors were closed accordingly.
...
/**
 * main - copies the content of  single file to another one.
